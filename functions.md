...
* iif(amount > 100, 'High')
* iif(DAY_OF_WEEK(saleDate) == 6, 'Weekend', 'Weekday')
*********************************
case
==============================
...
* toString(TO_DATE('2018-12-31')) -> '2018-12-31'
* toString(TO_DATE('2018-12-31'), 'mm/dd/yy') -> '12/31/18'
* toString(4 == 20) -> 'false'
*********************************
split
==============================
...
Adds a pair of strings or numbers. Adds a date to a number of days. Same as the + operator  
* add(10, 20) -> 30
* 10 + 20 -> 30
...
Converts a string to a date given a optional timestamp format  
...
min
==============================
<b>min(<i>&lt;value1&gt;</i> : number) => number</b><br/><br/>
Gets the minimum value of a column  
* min(sales) -> 00.01
*********************************
minIf
==============================
<b>minIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b><br/><br/>
Based on a criteria, gets the minimum value of a column  
* minIf(region == 'West', sales) -> 00.01
*********************************
max
==============================
<b>max(<i>&lt;value1&gt;</i> : number) => number</b><br/><br/>
Gets the maximum value of a column  
* MAX(sales) -> 12312131.12
*********************************
maxIf
==============================
<b>maxIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b><br/><br/>
